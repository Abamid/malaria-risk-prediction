...
st.markdown("""
    ...
    /* FIX: Force dark text inside positive (red) result box */
    .positive-result, .positive-result p, .positive-result li,
    .positive-result h2, .positive-result h3, .positive-result ul {
    ...
    /* FIX: Force dark text inside negative (green) result box */
    .negative-result, .negative-result p, .negative-result li,
    .negative-result h2, .negative-result h3, .negative-result ul {
        color: #1a1a1a !important;
    }
    .warning-box {
    ...
    /* FIX: Force dark text inside warning (orange) box */
    .warning-box, .warning-box p, .warning-box strong {
        color: #1a1a1a !important;
    }
    </style>
    ...
    if predicted_malaria == 1:
        st.markdown(f"""
            <div class="positive-result">
                ...
                <p style="font-size: 1.3rem; margin: 1rem 0; color: #1a1a1a;">
                    Confidence: <strong>{prediction_prob:.1%}</strong>
                </p>
                <hr style="border-color: #D32F2F;">
                <h3 style="color: #1a1a1a;">📋 Recommended Actions:</h3>
                <ul style="font-size: 1.05rem; color: #1a1a1a;">
        ...
        st.markdown(f"""
            <div class="negative-result">
                <h2 style="color: #2E7D32; margin: 0;"> MALARIA NEGATIVE (Low Risk)</h2>
                <p style="font-size: 1.3rem; margin: 1rem 0; color: #1a1a1a;">
                    Confidence: <strong>{prediction_prob:.1%}</strong>
                </p>
                <hr style="border-color: #4CAF50;">
                <h3 style="color: #1a1a1a;">📋 Recommendations:</h3>
                <ul style="font-size: 1.05rem; color: #1a1a1a;">
                ...
                <p style="color: #2E7D32; font-weight: bold; margin-top: 1rem;">
